...
export type AgentContactRequestFilterProps = {
...
type Props = {
  ...
  agentName: string
  locale: string
  filterProps: AgentContactRequestFilterProps
}

export function AgentContactRequestForm({ agentSlug, agentName, locale, filterProps }: Props) {
